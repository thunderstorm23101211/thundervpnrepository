...
<div class="container" style="padding-top: 50px;">
  <h1 class="text-center"><?php echo $site_name;?> Softether Account Creator </h1>
    <div class="row">
        <div class="col-md-6">
    <div class="card border-primary mb-3">
      <div class="card-header">Introduction</div>
      <div class="card-body">
        <h4 class="card-title">What is Softether Vpn?</h4>
        <p class="card-text">SoftEther VPN has a strong SSL-VPN protocol to penetrate any kinds of firewalls. Ultra-optimized SSL-VPN Protocol of SoftEther VPN has very fast throughput, low latency and firewall resistance.</p>
        <ul>
          <li>Fast</li>
          <li>Free</li>
          <li>Secure</li>
        </ul>
        - <?php echo $site_name;?> | Administrator
      </div>
    </div>
        </div>
        <div class="col-md-6">
    <div class="card border-primary mb-3">
      <div class="card-header">Create Softether Account</div>
      <div class="card-body">
      <form class="softether-create">
                        <div class="softether-result"></div>
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user-circle"></i></span>
                                </div>
                                <input type="text" class="form-control" placeholder="Enter Softether Username" name="username" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Softether Password" name="password" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" name="server">
                                    <option value="0">Select Softether Server</option>
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-action">CREATE ACCOUNT</button>
                    </form>
...
<footer>
 <div class="container pad-top">
         <p>Made with <font color=ea1646><i class="fas fa-heart"></i></font> by imKobz</p>
 </div>
</footer>
